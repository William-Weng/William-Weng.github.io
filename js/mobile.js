define([], function(){
    ...
    var renderDOM = function(){
        ...
        var tagStr = $tag?'<span class="viewer-title">標籤</span><div class="viewer-div tagcloud" id="js-mobile-tagcloud"></div>':"";
        var friendsStr = $friends?'<span class="viewer-title">友情連結</span><div class="viewer-div friends" id="js-mobile-friends"></div>':"";
        var aboutmeStr = $aboutme?'<span class="viewer-title">關於我</span><div class="viewer-div aboutme" id="js-mobile-aboutme"></div>':"";
