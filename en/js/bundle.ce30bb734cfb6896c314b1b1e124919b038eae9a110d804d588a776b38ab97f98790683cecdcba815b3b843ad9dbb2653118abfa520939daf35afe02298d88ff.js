...
const baseURL = 'https://William-Weng.github.io/';
...
const quickLinks = '搜尋到的結果';
const searchResultsLabel = '搜尋到的結果';
const shortSearchQuery = '搜尋字元太短'
const typeToSearch = '請輸入內容尋找';
const noMatchesFound = '未找到結果';
